...
---
*Source: [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills/blob/main/commercial/skills/rfp-responder/SKILL.md) (`commercial/skills/rfp-responder`), installed verbatim with its `scripts/`, `assets/`, and `references/` files.*
