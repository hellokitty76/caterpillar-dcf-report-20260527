...
- A. 44-page architectural design book (attach/reference)
- B. Project video (link)
- C. Site plans / land title documents
- D. Due diligence document checklist (to be assembled — legal, land, environmental, financial)
- E. Risk & compliance research brief (full version)
- F. Solar PV scenario research brief (full version)

---
*Drafted with the `contract-and-proposal-writer` skill conventions (bracketed placeholders, jurisdiction-aware clause thinking) and `rfp-responder` discipline (no invented figures — gaps are flagged, not papered over).*
